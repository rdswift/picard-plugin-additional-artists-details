# Form implementation generated from reading ui file 'options_additional_artists_details.ui'
#
...
class Ui_AdditionalArtistsDetailsOptionsPage(object):
    def setupUi(self, AdditionalArtistsDetailsOptionsPage):
        ...
        self.gb_process_track_artists = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.label = QtWidgets.QLabel(parent=self.gb_process_track_artists)
        self.label.setWordWrap(True)
        self.label.setObjectName("label")
        self.verticalLayout_4.addWidget(self.label)
        self.cb_process_tracks = QtWidgets.QCheckBox(parent=self.gb_process_track_artists)
        ...
        self.gb_area_details = QtWidgets.QGroupBox(parent=self.scrollAreaWidgetContents)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.gb_area_details)
